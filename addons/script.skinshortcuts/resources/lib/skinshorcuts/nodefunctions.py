...
class NodeFunctions:
    ...
    def add_to_menu(self, path, label, icon, content, window, data_func):
        ...
        # Get main menu items
        menuitems = data_func.get_shortcuts("mainmenu", process_shortcuts=False)
        ...
        menuitems = data_func.get_shortcuts(all_label_ids[selected_menu], process_shortcuts=False)
        data_func.clear_label_id()
    ...
    def set_properties(properties, values, label_id, group, data_func):
        ...
        menuitems = data_func.get_shortcuts(group, process_shortcuts=False)
        data_func.indent(menuitems.getroot())
