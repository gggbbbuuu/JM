...
class DirectSearch(Plugin):
    ...
    def search_include(self):
        r = requests.get(base64.b64decode("aHR0cDovL3JhY2luZ29uZGVtYW5kLnh5ei9ub25lb2Z5b3VyZWJ1c2luZXNzL2pzb24vbWFpbnhtbC9zZWFyY2hfaW5jbHVkZS5qc29u").decode("utf-8")).json()
        # r ="url" 
        return r
    ...
    def routes(self, plugin):
        ...
        def search(query):
            ...
            if "include" in plugin.args:
                ...
                include = ""
            games = extractor.search_extractors(query, include=self.search_include.get("search_include" + include, None))
