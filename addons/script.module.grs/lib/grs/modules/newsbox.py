...
import pyxbmct, re
from grs.modules import control, client
...
class Prompt(pyxbmct.AddonDialogWindow):
    ...
    def __init__(self):
        ...
        super(Prompt, self).__init__(NAME +' - Updates - Help')
    ...
    def set_controls(self):
        ...
        self.connect(self.github_button, lambda: control.open_web_browser('https://github.com/bugatsinho/bugatsinho.github.io/tree/master/plugin.video.releaseBB'))
        # Close button
        ...
        self.connect(self.changelog_button, lambda: news())
        # Disclaimer button
...
def news():
    _news = client.request('https://pastebin.com/raw/DTbzBCiT')
