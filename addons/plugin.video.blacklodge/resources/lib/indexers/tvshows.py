...
class tvshows:
    ...
    def networks(self):
        networks = [
            ...
            ('ABC Family', '75', 'https://i.imgur.com/qEJp4xk.png'),
            ...
            ('Discovery+', '4353', 'https://i.imgur.com/0XD00Xp.png'),
            ('Disney+', '2739', 'https://i.imgur.com/DVrPgbM.png'),
            ('Disney Channel', '54', 'https://i.imgur.com/ZCgEkp6.png'),
            ('Disney Junior', '281', 'https://i.imgur.com/modddCb.png'),
            ...
            ('Oxygen', '132', 'https://i.imgur.com/YEk9T70.png'),
            ...
            ('Peacock', '3353', 'https://i.imgur.com/9VdB3rg.png'),
