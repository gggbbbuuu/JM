            ...
            while True:
                ...
                while True:
                    ...
                    if choose == -1:
                        ...
                        return control.execute('Container.Update(%s?action=tvshows&url=%s)' % (sysaddon, urllib_parse.quote_plus(self.tmdb_tvpeople_link % c_id)))
                    elif choose == 1:
                        return control.execute('Container.Update(%s?action=movies&url=%s)' % (sysaddon, urllib_parse.quote_plus(self.tmdb_moviepeople_link % c_id)))
                    elif choose == 2:
                        self.bio_txt(c_id)
        except:
                ...
                if 'Director' in c_name:
                    while True:
                        ...
                        if choose == -1:
                            ...
                            return control.execute('Container.Update(%s?action=movies&url=%s)' % (sysaddon, urllib_parse.quote_plus(self.tmdb_moviedirector_link % c_id)))
                        elif choose == 1:
                            self.bio_txt(c_id)
                else:
                    while True:
